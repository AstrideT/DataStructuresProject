...
//Finding
the median of a dynamic linked list 

//If
n is even,then median is n/2

//If
n is odd, then median is (n-1)/2
...
              return headPtr;//pointing to head
node
...
       // add
code for the member function to find the value of the 
...
       cout << "Middle element
is:  " << integerList.findMiddleElement()
<< endl << endl;
