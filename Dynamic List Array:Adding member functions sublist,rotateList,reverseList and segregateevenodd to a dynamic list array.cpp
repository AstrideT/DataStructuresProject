...
//Project
1: Implementing the dynamic List ADT using array

//Creating
member functions: print,sublist,rotatelist, reverse list and segregate even odd
...
int maxSize;         // useful to decide if resizing (doubling the array size)
is needed
...
       void insert(int data)//inserts data at the end of
array
...
              i.e., move element at
deleteIndex+1 to deleteIndex and so on */
